 ...
 */
const PUNCHES = [
  { phrase: "что такое технологическая экспедиция в Китае", scale: 1.2 },
  { phrase: "это новые знакомства", scale: 1.16 },
  { phrase: "это новые точки роста", scale: 1.22 },
  { phrase: "присоединяйтесь к нам нашей экспедиции", scale: 1.18 },
  { phrase: "мы с вами посетим 12 заводов", scale: 1.22 },
];

const punchIns = PUNCHES.map((p) => ({ ...span(p.phrase), scale: p.scale, originY: 0.3 }));
