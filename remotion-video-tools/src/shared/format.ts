...
export const SAFE_AREAS = {
  ...
  /**
   * Instagram Stories. Сверху полоска прогресса и профиль, снизу строка
   * ответа — она заметно выше, чем подпись в Reels, поэтому низ режем
   * сильнее. Справа кнопок нет, в отличие от Reels.
   */
  stories: { top: 0.14, bottom: 0.16, sides: 0.07 },
