...
export type BrandTheme = {
  ...
  /**
   * Как карусель обходится с фото на слайде.
   * "overlay" (по умолчанию) — фото на весь кадр, текст поверх тёмного
   * градиента. "framed" — фон всегда светлый (surface), фото — в карточке
   * со скруглением и тонкой рамкой (colors.line), текст под ней тёмным по
   * светлому. GTT использует "framed" — деловой светлый тон сайта не
   * сочетается с тёмной заливкой под фото.
   */
  imageStyle?: "overlay" | "framed";
};
