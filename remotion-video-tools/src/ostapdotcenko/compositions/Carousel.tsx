...
/**
 * Personal-Carousel — слайд карусели Instagram для бренда.
 *
 ...
 */
export const personalCarouselSchema = carouselSchema;

export const PersonalCarousel: React.FC<CarouselProps> = ({
  slides,
  index,
  showCounter,
  showSwipeHint,
